...
$param_Trip_totals_daterange=array("StartDateTime"=>$StartDateTime ,"EndDateTime"=>$EndDateTime);
$response_Trip_totals_daterange =$TripsProcessesWS ->__soapCall('GetTripsWithTotalsForDateRange',array($param_Trip_totals_daterange));
echo '<pre>';
//print_r($response_Trip_totals_daterange);
$result_Trip_total_daterange=$response_Trip_totals_daterange->GetTripsWithTotalsForDateRangeResult->TripWithTotals;
