...
$param_Trip_totals_driver_daterange=array("driverId"=>9873,"StartDateTime"=>$StartDateTime ,"EndDateTime"=>$EndDateTime);
$response_Trip_totals_driver_daterange =$TripsProcessesWS ->__soapCall('GetTripsWithTotalsForDriverInDateRange',array($param_Trip_totals_driver_daterange));

echo '<pre>';
//print_r($response_Trip_totals_driver_daterange);

$result_Trip_total_daterange=$response_Trip_totals_driver_daterange->GetTripsWithTotalsForDriverInDateRangeResult->TripWithTotals;
