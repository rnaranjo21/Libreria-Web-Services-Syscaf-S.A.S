...
try {
$param_GetDefaultVehicleConfigParams=array("VehicleID"=>5050);
$response_DefaultVehicleConfigParams =$VehicleConfigurationProcessWS->__soapCall('GetDefaultVehicleConfigParams',array($param_GetDefaultVehicleConfigParams));
echo '<pre>';
//print_r($response_DefaultVehicleConfigParams);
$result_DefaultVehicleConfigParams=$response_DefaultVehicleConfigParams->GetDefaultVehicleConfigParamsResult->KeyValuePairOfIntConfigParam;
for ($i=0; $i <count($result_DefaultVehicleConfigParams) ; $i++) { 
    ...
    //$result_DefaultVehicleConfigParams_value_Units=$result_DefaultVehicleConfigParams->Value->Units;
