...
$param_recordedEvent=array("VehicleIDs"=>array("short"=>921),"StartDateTime"=>$StartDateTime,"EndDateTime"=>$EndDateTime,"EventDescriptionIDs"=>array("short"=>6 ));
$response_recordedEvent=$RecordedEventProcessesWS->__soapCall('GetEventsInDateRangeForVehicles',array($param_recordedEvent));
echo '<pre>';
//print_r($response_recordedEvent);

$result_recordedEvent_vehicle=$response_recordedEvent->GetEventsInDateRangeForVehiclesResult->RecordedEvent;
